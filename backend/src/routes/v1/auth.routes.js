...
import { sendOtpSchema, verifyOtpSchema, refreshTokenSchema, adminLoginSchema } from '../../validators/index.js';
...
router.post('/admin-login', authLimiter, validateBody(adminLoginSchema), adminLogin);
